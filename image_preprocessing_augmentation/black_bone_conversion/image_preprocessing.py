...
def coords_bounded_rotation(points, degree):
    """
    Input a 4x2 array representing a quadrilateral. Each row is a pair of coordinates of a corner point.
    Note that the origin of these coordinates is the center of the quadrilateral
    Output a 4x2 array where each row is a pair of coordinates after rotating the quadrilateral.
    """
...
def bounding_box_translation(image, corners, x, y):
    ...
    x and y are measured in # of pixels
    """
...
"""
def vb_patch_augmentation(vb_patches,
